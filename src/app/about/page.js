export default function About() {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">About Rentlets</h1>
      <p className="mb-4 text-slate-700">
        Rentlets is a leading real estate platform that specializes in helping
        clients rent properties in the most desirable neighborhoods. Our team of
